    ...
    <div class="parteuna-footer column is-5 animate fadeInUp">
      ...
      <div class="segunda-seccion column is-3">
        <div class="title-contacto-contenedor">
          <span class="title-contacto">Siguenos</span>
        </div>
      ...
      <div class="contenedorformulario">
        <div class="title-con-nosotros">
          ...
          <div class="parrafo-title">
            <span>
                Si tiene alguna pregunta o sugerencia, redacte su mensaje a travez del siguiente formulario de contacto
            </span>
          </div>
        </div>
        <div class="contenedor-input">
          ...
          <div class="parrafo-abajo-footer">
            ...
            <h4 class="parrafo-tercero">
              atencionalcliente@transblind.com
            </h4>
          </div>
        </div>
      </div>
    </div>
    <div class="parte-vacia column is-1"></div>
  </div>                
</footer>