...
<div class="contenedor-padre-nosotros">
  ...
  <div class="contenedor-cuadro-primario columns is-multiline is-paddingless">
    ...
    <div class="contenedor-img-right column is-6" style="background: url('{{ home_url('app/uploads/2018/09/portada.jpg') }} '); background-repeat: no-repeat; background-size: cover; height: 300px;"></div>  
  </div>
  <div class="contenedor-cuadro-secundario columns is-multiline is-paddingless">
    <div class="contenedor-img-left column is-6" style="background: url('{{ home_url('app/uploads/2018/09/portada.jpg') }} '); background-repeat: no-repeat; background-size: cover;  height: 300px;"></div>
  ...
  <div class="contenedor-padre-nuestro-valores is-multiline columns is-paddingless">
    <div class="contenedor-tarjeta-valores column is-5">
    ...
    <div class="contenedor-padre-descrip-valores column is-7 is-paddingless">
  ...
  <div class="contenedor-padre-conocer-nuestro-servicios">
    ...
    <div class="contenedor-boton-ir-servicios">
      <a href="" class="ver-servicios">Ver servicios</a>
    </div>
  </div>
</div>
@endsection